...
import GameDesignDiscoBall from './components/GameDesign-Jay/Disco_Ball-Jay'
...
const routes = [
  ...
  { path: '/photographer-profile-detail-page', component: VictorPhotographerProfileDetailPage},
